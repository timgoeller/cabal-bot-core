...
//         })
//       })
//       it('should call event when new message was published', function (done) {
//         var self = this
//         this.timeout(20000)
...
//         }
//       })
//       this.bot.joinCabals([this.firstKey, this.secondKey])
//     })
//   })

//   describe('#broadcast()', function () {
//     it('should send message to all joined cabals', function (done) {
//       var self = this
//       this.timeout(20000)
//       let messages = 0
//       this.secondClientCabal.on('new-message', (message) => {
//         messages += 1
//         if (messages === 2) {
//           done()
//         }
...
//         joined += 1
//         if (joined === 2) {
//           self.bot.broadcast(['default', 'introduction'], 'this is a test')
//         }
//       })
//       this.bot.joinCabals([this.firstKey, this.secondKey])
//     })
